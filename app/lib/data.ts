...
export const achievementsData: Achievement[] = [
	{
		...
		description:
			"1ª Olimpíada Nacional de Inteligência Artificial (ONIA) - 2024",
	},
	{
...
export const projectsData: Project[] = [
	{
		...
		problem:
			"Cuidadores e famílias de pessoas com Transtorno do Espectro Autista (TEA) enfrentam uma imensa sobrecarga na gestão de rotinas, terapias e informações de saúde, que ficam espalhadas em cadernos e aplicativos de mensagem, gerando fadiga mental e ansiedade.",
		approach:
			"O Bluery nasceu como um TCC técnico, mas que por um período foi tratado apenas como 'objeto acadêmico'. Em 2025, movido por um novo propósito e pela minha experiência pessoal, decidi reviver o projeto. Adotei uma postura de Liderança Servidora e Escuta Ativa, e fui a campo ouvir mais cuidadores reais para refinar a solução com foco na dor do usuário e garantir uma melhor proposta de valor.",
		technologies: "React Native (JS), Google Firebase, Node.Js, Expo, Figma",
		challenge:
			"O maior desafio não foi o código, mas sim transformar um 'projeto de nota' em um 'produto de impacto', engajando a equipe e aprendendo na prática conceitos de Liderança de Produto e Gestão Ágil.",
		results:
			"Versão 'Bluery 2.0' funcional, apresentada e validada como finalista na FETEPS 2025. Versão Beta atualmente em fase de testes de usabilidade com um grupo real de cuidadores.",
		links: [
	...
	{
		title:
			"Missão Astro Júnior - Classificação de Planetas com Machine Learning",
		problem:
			"O desafio, elaborado para a 1ª ONIA, era desenvolver um modelo de machine learning capaz de classificar planetas em cinco categorias distintas, com base em 13 categorias de dados de telemetria. O dataset apresentava um desequilíbrio de classes significativo, com a 'Classe 0' (Planeta Deserto) sendo muito mais frequente que as outras, como a 'Classe 3' (Planetal Florestal)",
		approach:
			"Este projeto foi um mergulho prático em fundamentos de IA. Tracei a seguinte abordagem: (1) Análise Exploratória de Dados (EDA): iniciei com a limpeza e análise dos dados, verificando valores ausentes e analisando a correlação entre as variáveis. (2) Modelagem Baseline: realizei a divisão dos dados entre treino e teste e avaliei o desempenho de seis modelos de classificação diferentes (KNN, Regressão Logística, XGBoost, etc.). (3) Otimização: Foquei nos modelos mais promissores e utilizei técnicas de _hyperparameter tuning_ para encontrar a melhor combinação de parâmetros.",
		technologies:
			"Python, Pandas, NumPy, Matplotlib/Seaborn(EDA e visualização), Sckit-learn (modelos de classificação), XGBoost e Optuna (otimização de parâmetros)",
		challenge:
			"O principal desafio foi lidar com o desequilíbrio de classes... Além disso, o processo de testar e otimizar múltiplos modelos exigiu uma abordagem metódica para comparar seus desempenhos (usando f1-score) e evitar o overfitting.",
		results:
			"O modelo baseline mais forte foi o XGBoost (76.2% de acurácia). Após uma otimização com GridSearchCV, o modelo XGBoost final alcançou uma acurácia de 78% e um F1-score ponderado de 0.77. O modelo treinado foi então utilizado para gerar o arquivo final de submissão enviado para a comissão avaliadora da olimpíada.",
		links: [
			{
				href: "https://github.com/DiasJoao002/missao-astro-junior",
	...
	},
	{
		...
		problem:
			"O cultivo de plantas em casa sofre com desafios de manutenção. O principal é a irrigação inadequada, tanto o excesso de água (que causa apodrecimento das raízes) quanto o déficit (que leva à desidratação) prejudicam as plantas e causam o desperdício de recursos hídricos",
		approach:
			"Alinhado à filosofia de 'tecnologia com propósito', o objetivo foi desenvolver um sistema de irrigação inteligente e automatizado. O núcleo do sistema é um microcontrolador Arduino que lê dados em tempo real de um sensor de umidade. O desenvolvimento incluiu prototipagem virtual no Tinkercad, experimento físico para a calibração do sensor e montagem de um protótipo físico.",
		technologies:
			"Hardware: Arduino Uno R3, Sensor de umidade do solo (HD38), Mini bomba d'água, Display LCD I2C, Software: Linguagem C/C++ (Arduino IDE), Tinkercad. Web: HTML, CSS, JavaScript, Bootstrap.",
		challenge:
			"O maior desafio técnico foi a calibração do sensor de umidade. A leitura 'crua' do sensor não é universal; ela depende do tipo de solo. Foi preciso realizar um experimento de 'Capacidade de Retenção do Solo'...",
		results:
			"O projeto resultou em um protótipo funcional, tanto virtual quanto físico. O sistema automatiza o cultivo, reduz o desperdício de água e facilita a produção de alimentos orgânicos em casa. O projeto foi documentado em um artigo científico e apresentado em um pitch deck.",
		links: [
			{
				href: "https://drive.google.com/drive/folders/10DMF3h5IOPtCrvcZI5XtmVWP_zjd_0Mq?usp=sharing",
				label: "Ver Materiais no Drive",
			},
		],
	},
	{
		...
		problem:
			"Consolidar minha jornada acadêmica, projetos e filosofia em uma plataforma web profissional, moderna e de alta performance.",
		approach:
			"Utilização de um stack JAMstack moderno para garantir performance, SEO e uma excelente experiência de desenvolvimento (DX), aplicando os conceitos de layout aprendidos.",
		technologies: "Next.js, React, TypeScript, Tailwind CSS e Vercel",
		challenge:
			"Estruturar a informação de forma lógica e contar minha história (storytelling) de maneira coesa, indo além de uma simples lista de projetos.",
		results: "O site que você está navegando agora.",
		links: [
			{
				href: "https://github.com/DiasJoao002/portfolio-academico",
				label: "Ver Repositório no GitHub",
			},
		],
	},
...
export const documentsData: DocumentItem[] = [
	{
		...
		links: [
			{
				href: "https://drive.google.com/file/d/1fPFv7v0jXQKXqBFOmnZJmrR_hg59SqX8/view?usp=sharing",
				label: "Documentação Resumida",
			},
			{
				href: "https://www.canva.com/design/DAGzvBhWC9E/SKWO89NOGjsoQfkC4cAiGw/view?utm_content=DAGzvBhWC9E&utm_campaign=designshare&utm_medium=link2&utm_source=uniquelinks&utlId=h8dfca7d324",
				label: "Pitch Deck",
			},
