...
import { FileText, Presentation, Link as LinkIcon, BookOpen } from 'lucide-react';
    ...
    <section id="documents" className="py-24 bg-white">
      <div className="container mx-auto px-4 max-w-5xl">
        <div className="flex items-center justify-center gap-3 mb-16">
          ...
          <h2 className="text-3xl font-bold text-zinc-900">Documentos e Publicações</h2>
        </div>
            ...
            >
              <div className="flex flex-col md:flex-row md:items-start gap-6">
                ...
                <div className="grow">
                  ...
                  <h3 className="text-2xl font-bold text-zinc-900 mb-4">{doc.title}</h3>
                  ...
                  <div className="flex flex-wrap gap-4">
                    {doc.links.map((link, linkIndex) => {
                      ...
                      let Icon = LinkIcon;
                      if (link.label.toLowerCase().includes('deck')) Icon = Presentation;
                      if (link.label.toLowerCase().includes('documentação') || link.label.toLowerCase().includes('artigo')) Icon = FileText;
