...
import { 
  ...
  SiTailwindcss, SiHtml5, SiCss3, SiNodedotjs,
  SiGit, SiGithub, SiLinux, SiScikitlearn, SiArduino 
} from 'react-icons/si';
import { DiScrum } from 'react-icons/di';
import { AiOutlineSecurityScan } from "react-icons/ai";
import { FaHandsHelping, FaComments, FaLightbulb, FaHeart, FaAws } from 'react-icons/fa';

// Mapeamento: Nome do Ícone -> Componente React
const iconMap: { [key: string]: React.ElementType } = {
  SiPython, SiJavascript, SiReact, SiNextdotjs, 
  SiTailwindcss, SiHtml5, SiCss3, SiNodedotjs,
  SiGit, SiGithub, SiLinux, SiScikitlearn, AiOutlineSecurityScan,
  DiScrum, FaHandsHelping, FaComments, FaLightbulb, FaHeart, FaAws, SiArduino 
};
